  ...
  return <View style={styles.container}>
      <ScrollView>
        <View style={styles.header}>
          ...
          <View style={styles.roundIconContainer}>
            <Image source={require("./assets/voiceIcon.png")} style={styles.icon} />
          </View>
          <View style={styles.roundIconContainer}>
        ...
        <Input placeholder="Enter Meeting ID" value={meetingID} onChange={setMeetingID} containerStyle={styles.input} />
        <Button buttonText="Enter Meeting" style={styles.button} hideShadow />
        <Button buttonText="+ Create Meeting" style={styles.button} hideShadow borderColor="#000" backgroundColor="#fff" textColor="#000" />
      </ScrollView>
    </View>;
};
